...
CREATE MATERIALIZED VIEW bloodgasarterial AS
with stg_spo2 as
(
...
left join stg_spo2 s1
  ...
  --and s1.charttime between bg.charttime - interval '1' hour and bg.charttime
...
left join stg_fio2 s2
  ...
  --and s2.charttime between bg.charttime - interval '1' hour and bg.charttime
