...
create table if not exists mimiciii.sepsis3_onsettime_new
(
	hadm_id int4,
	icustay_id int4,
	intime timestamp(0),
...
create index if not exists sepsis3_onsettimenew_icustay_id_idx
	on mimiciii.sepsis3_onsettime_new (icustay_id);