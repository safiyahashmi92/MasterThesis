# -*- coding: utf-8 -*-
"""2nd_FastCalculatingMissingValues_BtwSepsisOnset_ShockOnsetPlus10h_OR_SepsisOnset+41hrs.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CWZvrKZimtcvV1JTyrCUZf3s7hNhZpNT
"""
    ...
    for lines in wdb_records.readlines():
      ...
      if record[-1:] == 'n':
        ...
        try:
          ...
          sepsis_onsettime_plus_31h_or_ShockOnsettime = '';
          sepsis_onsettime= '';
          sepsis_onsettime_plus_41h= '';
          shock_onsettime= '';
          outtime= '';
          shock_onsettime_plus_10h= '';


          sepsis_onsettime = datetime.datetime.strptime(row['sepsis_onsettime'],'%Y-%m-%d %H:%M:%S') 

          outtime = datetime.datetime.strptime(row['outtime'],'%Y-%m-%d %H:%M:%S') 
...
df_csvdata.to_csv ('Only_AllSepsisPatients_with_MissingData_FromSepsisOnset_ToShockOnsetPlus10h_or_SepsisOnset+41h.csv', sep=',', index = False, header=True);


from google.colab import files
files.download('Only_AllSepsisPatients_with_MissingData_FromSepsisOnset_ToShockOnsetPlus10h_or_SepsisOnset+41h.csv')