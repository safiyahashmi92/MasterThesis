# -*- coding: utf-8 -*-
"""6TH_Extracting_hourly_sofa_236_btwSepsisOnset_ShockOnsetPlus10h_or_SepsisOnsetPlus41h_Patients_LessThan20%Missing.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18nfqhZrfoPQ1q6qPrJB3lgk__nf3BTiO
"""
...
select  bf.icustay_id as icustay_id,
        bf.calculation_time as calculation_time,
...
where  bf.calculation_time < bf.intime

union
select  en.icustay_id as icustay_id ,
        en.calculation_time as calculation_time,
...
from sepsis3_hourlysofa_entire_icustay en
    ) a
...
df_test = df_ALL1056_sofadata[df_ALL1056_sofadata['ICUSTAY_ID']== 271622]
print(df_test[['CALCULATION_TIME', 'SOFA_SCORE']])

df_ALL1056_sofadata.to_csv ('df_236_btwSepsisOnset_ShockOnsetPlus10h_or_SepsisOnsetPlus41h_Patients_LessThan20%Missing_sofadata.csv', sep=',', index = False, header=True);