# -*- coding: utf-8 -*-
"""17_ExtractingTEMPdataforAll_1024_SepsisOnsetPlus31hPatients_LessThanandMore20%Missing.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/11cMT5Uu4ac6L9JKyNychbH1u891wLvJw
"""
...
"""To extract TEMPERATURE DATA for all sepsis patients that have time overlap for sepsis onset and sepsis onset time + 31 hours (all patietns with less and more than 20% missing values)"""
...
df_AllSepsisOnsetPlus31h_tempdata.to_csv ('df_All_1024_SepsisOnsetPlus31h_tempdata.csv', sep=',', index = False, header=True);