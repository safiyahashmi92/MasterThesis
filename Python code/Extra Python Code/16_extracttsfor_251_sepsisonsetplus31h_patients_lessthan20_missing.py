# -*- coding: utf-8 -*-
"""16_extractTSFor_251_SepsisOnsetPlus31h_Patients_LessThan20%Missing.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PjsRvHftI0EMBIZMLX4NUtzIn1Zqx2qY
"""
...
df_csvdata = pd.read_csv(io.BytesIO(uploaded['2_Only_AllSepsisPatients_with_%MissingData_sepsisOnset+31_fluid+26.csv']))

print(df_csvdata.shape[0])
print(df_csvdata.columns)

df_sepsisOnset_SepsisOnsetPlus31h_csvdata = df_csvdata[(df_csvdata['Sepsis_SepsisOnset+31h_timeoverlap_exists']==1)& (df_csvdata['Sepsis_SepsisOnset+31h_percentNonMissingData']>=80) ]
...
df_ts_records_all_patients.to_csv ('df_ts_records_all251SepsisPatients(lessThan20%Missing)_sepsisOnsetPlus31h.csv', sep=',', index = False, header=True);

from google.colab import drive
drive.mount('/content/gdrive')

!cp "/content/df_ts_records_all251SepsisPatients(lessThan20%Missing)_sepsisOnsetPlus31h.csv" "/content/gdrive/My Drive/Master thesis"