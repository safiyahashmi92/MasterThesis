# -*- coding: utf-8 -*-
"""25_extractTSFor_256_SepsisOnset_ShockOnset_or_SepsisOnsetPlus31h_Patients_LessThan20%Missing.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1drVZCYt9k9AcQoqhAXmBi9Ba7l-yNy6I
"""
...
df_csvdata = pd.read_csv(io.BytesIO(uploaded['Only_AllSepsisPatients_with_MissingData_FromSepsisOnset_ToShockOnset_or_SepsisOnset+31h.csv']))
...
df_ts_records_all_patients.to_csv ('df_ts_records_all256SepsisPatients(lessThan20%Missing)_fromSepsisOnset_ShockOnset_or_sepsisOnsetPlus31h.csv', sep=',', index = False, header=True);

from google.colab import drive
drive.mount('/content/gdrive')

!cp "/content/df_ts_records_all256SepsisPatients(lessThan20%Missing)_fromSepsisOnset_ShockOnset_or_sepsisOnsetPlus31h.csv" "/content/gdrive/My Drive/Master thesis"